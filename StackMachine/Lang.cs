...
namespace StackMachine
{
    public static class Lang
    {
        ...
        public readonly static Terminal ASSIGN_OP   = new Terminal(nameof(ASSIGN_OP),        "^=$"),
        ...
        public static readonly Nonterminal lang = new Nonterminal(nameof(lang), MoreInserter, ZERO_AND_MORE),
            ...
            condition = new Nonterminal(nameof(condition), AndInserter(1, 3, 2), AND, L_B, stmt, LOGICAL_OP, stmt, R_B),
            for_condition = new Nonterminal(nameof(condition), AndInserter(0, 2, 1), AND, value, LOGICAL_OP, value),
            ...
            protected override void ExecuteCommand(string command)
            {
                switch (command)
                {
                    ...
                    case nameof(LIST_REMOVE):
                        ...
                        break;
                    default: // Объявлена новая переменная.
                        {
