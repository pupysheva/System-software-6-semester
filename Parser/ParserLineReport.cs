...
namespace Parser
{
    public class ParserLineReport : Exception
    {
        public ParserLineReport(string message, object expected, object actual, IList<Token> listWhereProblem, int TokenIndex)
        ...
        public ParserLineReport(object expected, object actual, IList<Token> listWhereProblem, int TokenIndex)
        ...
        public ParserLineReport(string messsage)
            : base(messsage) { }
        public ParserLineReport()
            : base() { }
